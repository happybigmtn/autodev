...
//!
//! Both passes run through Codex (gpt-5.6-sol by default). The first pass reads
...
fn build_finalizer_prompt(
    ...
    format!(
        r#"You are the finalizer for an `auto steward` pass. Both passes run under Codex gpt-5.6-sol by default; you are the second, independent look.
