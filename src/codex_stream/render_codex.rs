...
#[derive(Default)]
pub(super) struct CodexRenderState {
    pub(super) tool_count: usize,
    pub(super) exec_calls: HashMap<String, ExecCallState>,
    pub(super) usage: UsageSummary,
    pub(super) last_agent_message: Option<String>,
}

#[derive(Default)]
pub(super) struct ExecCallState {
    pub(super) output: String,
}

pub(super) fn render_codex_stream_line(line: &str, state: &mut CodexRenderState) -> String {
