...
mod tests {
    ...
    fn default_prompt_uses_resolved_branch() {
        ...
        assert!(
            prompt.contains(
                "identify the first actionable unfinished task marked `- [ ]` or `- [~]`"
            )
        );
